...
void testApp::openImageFile()
{
    ...
    {
        m_activeQuad->loadImageFromFile(dialog_result.getName(), dialog_result.getPath());
...
void testApp::openVideoFile()
{
    ...
    if(dialog_result.bSuccess)
    {
        m_activeQuad->loadVideoFromFile(dialog_result.getName(), dialog_result.getPath());
...
void testApp::loadSlideshow()
{
    ...
    if(dialog_result.bSuccess)
    {
        ...
        m_activeQuad->slideshowName = slideshowFolderName;
